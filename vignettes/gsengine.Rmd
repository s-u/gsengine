...
output: 
  ...
  rmarkdown::pdf_document:
    toc: true
    fig_caption: true
header-includes: \usepackage{longtable, booktabs}
vignette: >
...
```{gs, saveTables=TRUE, echo=FALSE, results='hide'}
IMPORT [PRINT=*] '%DATA%/WheatTrials.xlsx'; SHEET='Trial A1'
TREATMENTS Cultivar
BLOCKS Rep
ANOVA [FPROB=yes; PSE=LSD] Mean_Population_m2
...
```{gs, label="wheat_anova", saveTables=TRUE, echo=FALSE, results="hide"}
IMPORT [PRINT=*] '%DATA%/WheatTrials.xlsx'; SHEET='Trial A1'
TREATMENTS Cultivar
BLOCKS Rep
ANOVA [FPROB=yes; PSE=LSD] Mean_Population_m2
...
```{gs, saveTables="wheat_anova", include=FALSE}
IMPORT [PRINT=*] '%DATA%/WheatTrials.xlsx'; SHEET='Trial A1'
TREATMENTS Cultivar
BLOCKS Rep
ANOVA [FPROB=yes; PSE=LSD] Mean_Population_m2
...
```{gs, saveTables="foo", include=FALSE}
VARIATE [VALUES=1,2,3] Foo
PRINT Foo
```
...
```{gs, saveTables=c("anovatbl", "meanstbl"), include=FALSE}
IMPORT [PRINT=*] '%DATA%/WheatTrials.xlsx'; SHEET='Trial A1'
TREATMENTS Cultivar
BLOCKS Rep
ANOVA [FPROB=yes; PSE=LSD] Mean_Population_m2
...
````{markdown eval=FALSE, highlight=FALSE}
`r pval`
````
